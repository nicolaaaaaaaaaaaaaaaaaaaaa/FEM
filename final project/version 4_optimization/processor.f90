module processor
    ...
    public :: input, output, stopwatch, plotmatlabdef, plotmatlabeval, plotmatlabevec, plotmatlabeig, &
        plotmatlabdefplate, plotmatlab_direction
    private
...
!
    subroutine output
        ...
        write (10, '("number      theta       1-direction       2-direction       3-direction        sigma 1           &
        sigma 2             direction" )')
        do e = 1, ne
            ...
            case( 2 )
                write (10, '(1x, i6, 1x, f10.5, 3(1x, f17.9), 1x, 3(1x, f17.9))')e, theta_array(e),(strain(e, i),i = 1,3),&
                (principal_stresses(e, i),i = 1,3)
            end select
        end do
