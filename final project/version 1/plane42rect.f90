module plane42rect
    ...
    private
    public :: plane42rect_ke, plane42rect_re, plane42rect_ss, shell41_ke, shell41_ss
...
subroutine shell41_ke(xe, young, nu, thk, ke)
        ...
        ke(1,1) = -0.10D2 * EE * (aa ** 4 - bb ** 2 * (nu - 0.7D1 / 0.2D1)* aa ** 2 / 0.5D1 + bb ** 4) * t ** 3 / &
        ...
        ke(1,4) = -0.5D1 * (aa ** 4 + 0.2D1 / 0.5D1 * bb ** 2 * (nu - 0.7D1 / 0.2D1) * aa ** 2 - 0.2D1 * bb ** 4) &
            * EE * t ** 3 / (0.120D3 * nu ** 2 - 0.120D3) / bb ** 3 / aa ** 3
        ...
        ke(10,7) = -0.5D1 * (aa ** 4 + 0.2D1 / 0.5D1 * bb ** 2 * (nu - 0.7D1 / 0.2D1) * aa ** 2 - 0.2D1 * bb ** 4)&
            * EE * t ** 3 / (0.120D3 * nu ** 2 - 0.120D3) / bb ** 3 / aa ** 3
...
!--------------------------------------------------------------------------------------------------
!
    subroutine shell41_ss(xe, de, young, nu, estress, estrain, eprincipal_stresses, esigmavm)
