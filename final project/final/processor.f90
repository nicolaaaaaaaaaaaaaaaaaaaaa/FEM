module processor
    ...
    public :: input, output, stopwatch, plotmatlabdef, plotmatlabeval, plotmatlabevec, plotmatlabeig,&
     plotmatlabdefplate, plotmatlab_direction, plotmatlab_eigen
    private
    ...
    subroutine input
        ...
        do
            ...
            case ('N', 'n')
                ...
                read (10, *) command, ivalue, x(ivalue, 1), x(ivalue, 2), x(ivalue, 3)
...
!
    subroutine output
        ...
        write (10, '("number           W              PSI1           PSI2          1-direction     2-direction    3-direction")')
        do i = 1, nn
            write(10,'(i6, 1x, f15.7, 1x, f15.7, 1x, f15.7, 2x, f15.7, 1x, f15.7, 1x, f15.7)')i, &
            d(3*i-2), d(3*i-1), d(3*i), p(3*i-2), p(3*i-1), p(3*i)
        end do
        ...
        write (10, *)
        write (10, '("Element                    Element strain                                   Principal stresses")')
        write (10, '("number      1-direction       2-direction       3-direction        sigma 1           sigma 2          &
        direction" )')
        do e = 1, ne
            ...
            case( 2 )
                write (10, '(1x, i6, 3(1x, f17.5), 1x, 3(1x, f17.5))')e,(strain(e, i),i = 1,3),(principal_stresses(e, i),i = 1,3)
            end select
        end do
...
!--------------------------------------------------------------------------------------------------
!
   subroutine plotmatlabdefplate(title)
        ...
        ! write datafile
        imatlab = imatlab + 1
        write (fdata, '(a,"_plotdeformed3D_data",i0.4,".m")') trim(filename), imatlab
        open (13, file=trim(fdata))
        ...
        ! Create matlab script
        write(fscript, '(a,"_plotdeformed3D_",i0.4,".m")' ) trim(filename), imatlab
        open (13, file = trim(fscript))
        write(13,*) '% Plotting Un-Deformed and Deformed Structure'
        write(13,*) 'close all'
        write(13,*) 'clear all'
        ...
        if (element(1)%id == 1) then
            ...
            write(13,*) '    xx = X(IX(e,1:4),1);'
            write(13,*) '    yy = X(IX(e,1:4),2);'
            write(13,*) '    zz = D(edof(1:3:12));'
            write(13,*) '    patch(xx, yy, zz, [1 1 0], "FaceAlpha", 0.8);'
            write(13,*) 'end'
            write(13,*) 'view(3)'
            write(13,*) 'title(',"'",'Deformed',"'",')'
            write(13,*) 'axis equal;'
            ...
            write(13,*) '    xx =  X(IX(e,1:4),1);'
            write(13,*) '    yy =  X(IX(e,1:4),2);'
            write(13,*) '    zz0 = X(IX(e,1:4),3);'
            write(13,*) '    patch(xx, yy, zz0, [1 1 0]);'
            write(13,*) 'end'
            write(13,*) 'title(',"'",'Undeformed',"'",')'
            write(13,*) 'axis([min(xaxes(1),min(X(:,1))) max(xaxes(2),max(X(:,1)))...'
            write(13,*) ' min(yaxes(1),min(X(:,2))) max(yaxes(2),max(X(:,2))) ]);'
        ...
        ! Print to screen:
        print*,' '
        print*,'Matlab plotting called: un/deformed for plate elements'
        print*,'Generated data file: ', trim(fdata)
        print*,'and script file: ', trim(fscript)
        print*,' '
    end subroutine plotmatlabdefplate
...
!
    ...
    subroutine plotmatlaboutplane(title)
        ...
        print*,'and script file: ', trim(fscript)
        print*,' '
    end subroutine plotmatlaboutplane
!
!--------------------------------------------------------------------------------------------------
!
...
!--------------------------------------------------------------------------------------------------
!
    subroutine plotmatlab_eigen(num,title,data1)
        ...
        ! write datafile
        imatlab = imatlab + 1
        !write (fdata, '(a,"_plot_eigen_data_",i0.4,".m")') trim(filename), imatlab
        write (fdata, '(a,"_plot_eigen",i0.4,"_data_",i0.4,".m")') trim(filename), num,imatlab
        ...
        ! Create matlab script
        !write(fscript, '(a,"_plot_eigen_",i0.4,".m")' ) trim(filename), imatlab
        write (fscript, '(a,"_plot_eigen",i0.4,"_",i0.4,".m")') trim(filename), num, imatlab
        open (13, file = trim(fscript))
        write(13,*) '% Plotting Element Values'
        write(13,*) 'close all'
        write(13,*) 'clear all'
        ...
        print*,' '
        print*,'Thank you bye bye'
    end subroutine plotmatlab_eigen
!
!--------------------------------------------------------------------------------------------------
!
...
!
    ...
    subroutine plotmatlab_direction(title,direction)
        ...
        ! write datafile
        imatlab = imatlab + 1
        write (fdata, '(a,"_direction_data",i0.4,".m")') trim(filename), imatlab
        open (13, file=trim(fdata))
        ...
        write(13,'("vect = [")')
        do i = 1, ne
            write(13,*) direction(i)
        end do
        write(13,'("];")')
        close(13)

        ! Create matlab script
        write(fscript, '(a,"_direction_",i0.4,".m")' ) trim(filename), imatlab
        open (13, file = trim(fscript))
        write(13,*) '% Plotting Vector Field, i.e. principle stresses'
        write(13,*) 'close all'
        write(13,*) 'clear all'
        ...
        if (element(1)%id == 1) then
            ...
            write(13,*) ''
            write(13,*) '% define parameters:'
            write(13,*) ' scale_factor = 0.4;'
            write(13,*) '% Define characteristic length'
            write(13,*) ' clx = 0;'
            write(13,*) ' cly = 0;'
            write(13,*) ' for e = 1:size(IX,1)'
            ...
            write(13,*) ' end'
            write(13,*) ' clmax = max(clx, cly);'
            write(13,*) ' scal = clmax * scale_factor;'
            write(13,*) ''
            write(13,*) '% Make plot'
            write(13,*) ' figure'
            write(13,*) ' hold on'
            ...
            write(13,*) '     xc = sum(X(IX(e,:),1))/size(IX,2);'
            write(13,*) '     yc = sum(X(IX(e,:),2))/size(IX,2);'
            write(13,*) '     vec = [cos(-vect(e)) sin(-vect(e)) cos(-vect(e)+pi/2) sin(-vect(e)+pi/2)];'
            write(13,*) '     cc = "k";'
            write(13,*) '     quiver(xc,yc,vec(1),vec(2),  scal,cc);'
            write(13,*) '     quiver(xc,yc,-vec(1),-vec(2),scal,cc);'
            write(13,*) ' end'
        ...
        print*,'and script file: ', trim(fscript)
        print*,' '
    end subroutine plotmatlab_direction
