    ...
    subroutine enforce
        ...
        if (.not. banded) then
            ...
            do i = 1, nb
                ...
                ! diagonal shorted than idof, avoid "hitting the side"
                if (idof <= bw) then
                    posit = 1
                    do n = 1, idof          ! kvector has no zero on top, only on the bottom
                        c = n
                        r = idof + 1 - n
                        kevector(n) = kmat(r,c)
                        kmat(r,c) = 0
                ...
                ! full diagonal
                    ...
                    posit = idof - bw      ! kvector has zero both on top and bottom
                    do n = 1, bw
                        c = idof - bw + n
                        r = bw + 1 - n
...
!
    subroutine compliance
        ...
        integer :: i, j, k, m, l, c, r, krow, kcol, a, n, posit
