    ...
    subroutine buildstiff
        ...
        do e = 1, ne
            ...
            case( 2 )
                 ...
                 call plane42_ke(xe, young, nu, thk, ke, dens, me)
    ...
    subroutine recover
        ...
        do e = 1, ne
            ...
            case( 2 )
                 ...
                 call plane42_ss(xe, de, young, nu, estress, estrain, eprincipal_stresses, esigmavm)
                 stress(e, 1:3) = estress
                 strain(e, 1:3) = estrain
