...
contains
    ...
    subroutine plane42_ke(xe, young, nu, thk, ke, dens, me)
        ...
        do i = 1, ng
            do j = 1, ng
                ...
                me = me + w1*w2*thk*dens*matmul(transpose(n),n)*detjac
...
!--------------------------------------------------------------------------------------------------
!
    subroutine plane42_ss(xe, de, young, nu, estress, estrain, eprincipal_stresses, esigmavm)
